...
# ──────────────────────────────────────────────
#  Flow Step = ActNorm + Inv1x1Conv + Coupling
# ──────────────────────────────────────────────
...
class Glow(nn.Module):
    ...
    def sample(self, n_samples, device, temperature=0.7):
        ...
        zs.append(
            torch.randn(n_samples, 6, 6, 6, device=device) * temperature
        )

        zs.append(
            torch.randn(n_samples, 24, 3, 3, device=device) * temperature
        )
